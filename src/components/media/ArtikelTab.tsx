...
export function ArtikelTab() {
  ...
  useEffect(() => {
    async function fetchPaginatedArtikels() {
      try {
        setLoading(true);
        const data = await dataService.getMediaItems('artikel', {
          page: currentPage,
      ...
      <div className={isGridView ? "grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8" : "space-y-8 max-w-5xl mx-auto"}>
        ...
        {paginatedData.length === 0 && (
          <div className="py-20 text-center col-span-full">
             ...
             <p className="text-gray-500 font-bold uppercase tracking-widest">Tidak ada artikel yang ditemukan</p>
          </div>
        )}
