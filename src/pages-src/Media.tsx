          ...
          {tabHeaders[activeTab] && (
            ...
            >
              <div className="flex items-center gap-6">
                <div className={`size-20 rounded-[1.5rem] flex items-center justify-center ${tabHeaders[activeTab].color} shadow-inner`}>
                  {(() => {
                ...
                <div>
                  <h2 className="text-4xl font-black text-[#092C74] tracking-tighter mb-2">{tabHeaders[activeTab].title}</h2>
                  <p className="text-sm text-gray-400 font-black uppercase tracking-[0.2em]">{tabHeaders[activeTab].subtitle}</p>
                </div>
              </div>
