    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[65vh] min-h-[500px] overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#092C74]/95 via-[#092C74]/60 to-transparent" />
        </div>
          ...
          <div className="container mx-auto px-4 pb-16">
            ...
            >
              <div className="flex flex-wrap gap-3 mb-6">
                <span className="bg-[#E31D1A] text-white px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest shadow-lg">
                  {event.category}
                </span>
                <span className="bg-white/10 backdrop-blur-md text-white px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest">
                  STTB Event
                </span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-black text-white mb-8 leading-[1.1] max-w-5xl drop-shadow-2xl">
                {event.name || event.title}
              </h1>

              <div className="flex flex-wrap gap-8 text-white/90 bg-black/10 backdrop-blur-sm p-6 rounded-2xl border border-white/10 w-fit">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-12 max-w-7xl mx-auto">
            ...
            <div className="lg:w-2/3">
              <div className="bg-white p-10 md:p-16 rounded-[40px] shadow-xl border border-gray-100 relative -mt-32 z-10">
                <div className="flex justify-between items-center mb-12 pb-8 border-b border-gray-100">
                  <h2 className="text-3xl font-black text-[#092C74] uppercase tracking-tighter">Deskripsi Acara</h2>
                  <div className="flex gap-4">
                    <Button variant="outline" size="icon" className="rounded-full size-12 shadow-sm">
                      <Share2 className="size-5 text-[#092C74]" />
                    </Button>
                  </div>
                </div>

                <div className="prose prose-xl prose-slate max-w-none text-gray-700 leading-relaxed">
                  <p className="font-bold text-[#1C64E8] mb-10 text-2xl leading-relaxed">
                    {event.description}
                  </p>
