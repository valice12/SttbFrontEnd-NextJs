      ...
      <div className="bg-white border-b sticky top-32 z-30 shadow-sm">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center gap-2 text-xs font-bold text-gray-500 uppercase tracking-widest">
            <Link href="/media?tab=jurnal" className="hover:text-[#092C74]">Jurnal Stulos</Link>
            <ChevronRight className="size-3" />
            <span className="text-[#092C74]">{journal.title}</span>
          </div>
          ...
          <div className="lg:w-3/4">
            ...
            >
              <div className="mb-10">
                ...
                <div className="flex flex-wrap items-center gap-8 py-6 border-y border-gray-100 mb-10 text-gray-600">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-bold text-gray-900">{journal.author || 'Tim Akademik STTB'}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Bookmark className="size-4 text-[#E31D1A]" />
                    <span className="text-sm font-bold text-gray-900">Volume 22 • STT Bandung</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Scale className="size-4 text-[#E31D1A]" />
                    <span className="text-sm font-bold text-gray-900">ISSN: 2085-3394</span>
                  </div>
                </div>
              </div>
              ...
              <div className="prose prose-lg max-w-none">
                <h2 className="text-2xl font-black text-[#092C74] mb-6 uppercase tracking-tight">Abstract</h2>
                <div className="text-gray-700 leading-relaxed text-lg bg-gray-50 p-8 rounded-2xl italic mb-10 border-l-4 border-[#092C74]">
                  {journal.description}
                </div>
